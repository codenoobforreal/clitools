...
describe("getFileNameFromPath", () => {
  it("should extract the correct filename from a standard path", () => {
  ...
  it("should handle a path with multiple dots in the filename", () => {
    const filePath = "/user/configs/settings.v1.0.0.json";
    const expectedFileName = "settings.v1.0.0";
    expect(getFileNameFromPath(filePath)).toBe(expectedFileName);
  });
  it("should handle a path that is just the root directory", () => {
    const filePath = "/";
    const expectedFileName = "";
    expect(getFileNameFromPath(filePath)).toBe(expectedFileName);
  });
  it("should handle a path with no filename", () => {
...
describe("getFileExt", () => {
  ...
  it("should return the correct extension for a full path", () => {
...
describe("resolveAndNormalizePath", () => {
  ...
  it("should resolve relative path with base directory", async () => {
  ...
  it("should handle current directory notation", async () => {
